...
<script type="text/javascript">
	$(document).ready(function(){
		_FRM = document.findMovieTheatersForm;
// 		findMovieTheatersName('CGV,메가박스,롯데시네마');
	});
</script>
<div class="s003">
	<form id="findMovieTheatersForm" name="findMovieTheatersForm" onsubmit="return false;">
		<p><h2>FIND THEATERS</h2></p>
        <div class="inner-form" style=" margin-top:40px; position: relative; z-index: 2;">
          ...
          <div class="input-field third-wrap">
            <button class="btn-search" type="button" onclick="fnFindMovieTheaters();">
